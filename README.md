...
```
You can check with url: http://localhost:8080/

 
I have finish **Features Required**, **Tech Requirement**, some feature of **Optional** (Sort, Filter) and also:
- Styling with Scss, Style components
- No use UI framework
- Use Redux
- Config Webpack (via next.config.js) for the production and development environment.
